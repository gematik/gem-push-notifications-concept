...
===== GCM (Google Cloud Messaging)
 ...
 - wo kommt prio hin?
 - wo kommt crypto payload hin
 - braucht man ein property um auf dem gerät entschlüsseln zu können oder geht das immer?

.HTTP-Header
|===
| HTTP-Header | Wert | Beschreibung
| `:method` | `POST` |
| `:path` | `TODO /3/device/*<pushkey>*` |
| authorization | `TODO *<provider_token>*` | Required for token-based authentication
|===
